...
void ImGuiRenderer::add_drawer(ImGuiDrawer* drawer) { this->m_drawers.push_back(drawer); }

void ImGuiRenderer::handle_event(const SDL_Event& e) { ImGui_ImplSDL2_ProcessEvent(&e); }
